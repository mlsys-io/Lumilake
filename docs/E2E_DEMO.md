...
| hybrid-api-chat-chain | `examples/templates/yaml/hybrid-api-chat-chain.yaml` | – | API-mode LLMChatOp → local LLMChatOp → API-mode LLMChatOp, proving api/local are pure backend switches |
