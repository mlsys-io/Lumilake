...
from lumilake.ops.util_ops import FutureOp
from lumilake.utils.prefix.radix_tree import Placeholder, PrefixType
...
class EnterOp(FunctionalOp):
    ...
    def get_prefix_template(
        ...
        raise NotImplementedError("EnterOp does not support prefix templates.")
...
class _SubGraph:
    ...
    def replace_inputs(self, new_input_map: dict[Op, Op]) -> None:
        """Substitute the inputs of the subgraph with new inputs
