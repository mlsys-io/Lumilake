...
_OPTIONAL_KEYS: tuple[str, ...] = (
    ...
    "LUMILAKE_WORKER_GROUP_WAIT_SECONDS",
    "LUMILAKE_HTTP_TIMEOUT_SECONDS",
    "LUMILAKE_QUEUE_QUANTUM_HIGH",
    "LUMILAKE_QUEUE_QUANTUM_LOW",
    "LUMILAKE_QUEUE_QUANTUM_MEDIUM",
    "LUMILAKE_SCHEDULER_POLICY",
    "LUMILAKE_CAPACITY_AWARE_SELECTION",
    "LUMILAKE_UNSATISFIABLE_DWELL_OBSERVATIONS",
    "LUMILAKE_UNSATISFIABLE_DWELL_SECONDS",
    "LUMILAKE_FAIRNESS_HALF_LIFE_SECONDS",
    "LUMILAKE_FAIR_SHARE_TARGET",
    "LUMILAKE_SETUP_COST_SIGMA",
    "LUMILAKE_COST_DB_SEC_PER_QUERY",
    "LUMILAKE_COST_CPU_SEC_PER_NODE",
    "LUMILAKE_COST_DEFAULT_MODEL_SIZE_B",
    "LUMILAKE_COST_INPUT_QUERY_COUNT",
